    ...
    <motion.button
      ...
      className={`absolute bottom-0 left-0 right-0 max-sm:z-50 max-sm:fixed  max-sm:bg-slate-300  border-t  border-slate-300 transition-colors md:hover:bg-slate-100 dark:md:hover:bg-gray-700 dark:text-white ${
        open
          ...
          : "max-sm:max-w-14 max-sm:max-h-14 max-sm:bg-gray-100 max-sm:dark:bg-slate-950 max-sm:border-2 max-sm:border-r-2 max-sm:border-slate-400 max-sm:dark:border-2 max-sm:rounded-full max-sm:bottom-4 max-sm:left-3"
      }`}
    >
