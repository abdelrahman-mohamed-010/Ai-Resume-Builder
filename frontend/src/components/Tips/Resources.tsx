    ...
    <section className="mb-12 w-full dark:bg-dark-background rounded-lg mt-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
        {newResources.map((resource, index) => (
          ...
          >
            <img
              src={`https://img.youtube.com/vi/${resource.imageId}/hqdefault.jpg`}
              srcSet={`
                https://img.youtube.com/vi/${resource.imageId}/default.jpg 120w,
                https://img.youtube.com/vi/${resource.imageId}/mqdefault.jpg 320w,
                https://img.youtube.com/vi/${resource.imageId}/hqdefault.jpg 480w,
                https://img.youtube.com/vi/${resource.imageId}/maxresdefault.jpg 1280w
              `}
              alt={resource.title}
              className="w-full h-auto object-cover mb-4 rounded-md"
              loading="lazy"
